...
MIGRATION = ROOT / "drizzle" / "0000_clever_gateway.sql"
...
def main() -> None:
    ...
    assert table_count == 12, f"Expected 12 tables, found {table_count}"
    ...
    print(
        ...
        f"SETTINGS={setting_count} FK_ERRORS={len(foreign_key_errors)}"
    )
